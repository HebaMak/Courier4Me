...
* The app consists of some pages and components: 
  * Home page: which displays the app features and direct user to the request page to make a request or register as a courier to select other's deliveries to deliver
